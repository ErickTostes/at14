  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/create-product"
          element={<PrivateRoute element={<CreateProduct />} isAuthenticated={isAuthenticated} />}
        />
        <Route
          path="/fornecedores"
          element={<PrivateRoute element={<SupplierList />} isAuthenticated={isAuthenticated} />}
        />
        <Route
          path="/create-supplier"
          element={<PrivateRoute element={<CreateSupplier />} isAuthenticated={isAuthenticated} />}
        />
      </Routes>
    </Router>
  );
